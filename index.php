  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="menu">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link text-white" href="php/login.php">Login</a></li>
        <li class="nav-item"><a class="nav-link text-white" href="templates/register.html">Register</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="hero">
  ...
  <div>
    ...
    <a href="php/login.php" class="btn btn-primary btn-lg mt-4">Get Started</a>
  </div>
</div>
