            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        for($i=1;$i<=8;$i++){
                            echo '<li><a class="dropdown-item" href="view-materials.php?sem=Semester '.$i.'&type=Note">Semester '.$i.'</a></li>';
                        }
                        ?>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        for($i=1;$i<=8;$i++){
                            echo '<li><a class="dropdown-item" href="view-materials.php?sem=Semester '.$i.'&type=Questions">Semester '.$i.'</a></li>';
                        }
                        ?>
                    </ul>
                </li>
